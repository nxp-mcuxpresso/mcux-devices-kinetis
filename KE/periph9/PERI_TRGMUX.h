...
typedef struct {
  __IO uint32_t TRGCFG[TRGMUX_TRGCFG_COUNT];       /**< TRGMUX CTRL0..TRGMUX LPUART2, array offset: 0x0, array step: 0x4, irregular array, not all indices are valid */
} TRGMUX_Type;
...
/*! @name TRGCFG - TRGMUX CTRL0..TRGMUX LPUART2 */
/*! @{ */
